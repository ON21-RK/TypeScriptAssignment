/**
 * Original code from:
 * https://github.com/hankchizljaw/vanilla-js-state-management/blob/master/src/js/store/store.js
 */
 ...
 export default class Store {
     ...
     private mutations: { [key: string]: Function } = {}
     private state = {}
     private status: string = "resting"
